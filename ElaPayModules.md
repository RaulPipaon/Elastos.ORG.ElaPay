...
### ElaPay Service (ElaPay服务)
 ...
          - Order infomation, Order amount, price of RMB/USD/JPY... or ELA.  (订单信息)
          ...
          - exchange rate adjustExchange rate adjustment. 
            Currency exchange rate with ELA can be adjusted up or down.
      ...
      - <div id="PayResult">User payment notification interface (用户付款通知接口)</div>
...
### Query exchange rate service (查询汇率服务)
  ...
  - <div id="QueryRate">Query exchange rate interface (汇率查询接口)</div>
...
### Web Wallet (网页钱包)
  ...
  - <div id="RequestWallet">Quick payment page (快捷支付页面)</div>
